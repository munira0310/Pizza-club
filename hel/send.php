...
require_once "phpmailer/phpmailer.php"; 
 ...
 $mail->Body    = ' Имя: '.$name .' <br> Телефон: '.$phone.'<br>  Тип: '.'<br>'. $radio ."  ".$radio1."   ".$radio2."   ".$radio3;
 $mail->AltBody = '';
...
if($name !="" ){
            ...
            $url = "http://185.200.242.53/getdata.php?name=$name&phone=$phone&radio=$radio&radio1=$radio1&radio2=$radio2&radio3=$radio3";
            $ch = curl_init();
